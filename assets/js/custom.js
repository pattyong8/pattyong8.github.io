...
======================================*/
    ...
    // 3.Countdown timer
        ...
        function makeTimer() {
                ...
                var endTime = new Date("October 29, 2021 12:00:00 PDT");
        ...
        //=============
			...
			// 8.animation support (added 8/21/2020)
					...
					$(window).load(function(){
							...
							$(".memories-home h1").removeClass("animated fadeInUp").css({'opacity':'0'});
							$(".memories-home p").removeClass("animated fadeInDown").css({'opacity':'0'});
					...
					$(window).load(function(){
							...
							$(".memories-home h1").addClass("animated fadeInUp").css({'opacity':'0'});
							$(".memories-home p").addClass("animated fadeInDown").css({'opacity':'0'});
